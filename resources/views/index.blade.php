        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="flex flex-col justify-center">
                <h1
                    ...
                    Sistema para control de Operadores y Equipos</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Se esta utilizando Laravel + Tailwind + Flowbite utilizando como
                    motor de base de datos MYSQL con la ayuda de DBeaber para visualizar los datos. Utilizando asi mismo, MVC para la ejecución del flujo del sistema.</p>
